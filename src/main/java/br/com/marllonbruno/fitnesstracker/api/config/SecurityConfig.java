package br.com.marllonbruno.fitnesstracker.api.config;
...
public class SecurityConfig {
     ...
     * O Spring usará este método para injetar o PasswordEncoder em outras classes,
     * como na sua AuthService.
     */
    @Bean
